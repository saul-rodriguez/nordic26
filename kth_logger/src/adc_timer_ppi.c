...
void configure_saadc(void)
{
     ...
     * SAULS CODE STARTS HERE
     */
        // Here we can set the desired acquisition time (e.g., 10 microseconds)
...
void sendADCdata(int16_t adc_value)
{
    ...
    if (ADC_data_counter >= MAX_DATA_SIZE) {
        ...
        // Commented out the printk statement to reduce console output and avoid potential performance issues
